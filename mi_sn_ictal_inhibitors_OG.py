...
from DCEpy.Features.BurnsStudy.Mutual_Information.centralities import compute_katz, pagerank_centrality
from sklearn import svm
import os, pickle, sys
from DCEpy.General.DataInterfacing.edfread import edfread
from ictal_inhibitors_final import classifier_gridsearch, label_classes, window_to_samples, choose_best_channels, performance_stats
from DCEpy.Features.BurnsStudy.Mutual_Information.mutual_information import window_data, cross_channel_MI, notch_filter_data
# from Experiments.extract_scattering import extract_scattering_coefficients
import matplotlib.pyplot as plt
from ictal_inhibitors_final import find_katz, analyze_patient_raw
...
def get_MI_features(patient_id, filename, freq_bands = ["theta", "gamma"], chunk_len = 300):
    ...
    h_path = "/Users/TianyiZhang/Desktop/PatientData"
    ...
    if int(chunk_len) == 300:
        data_mat = scipy.io.loadmat(os.path.join("/Users/TianyiZhang/Documents/EpilepsyVIP/DCEpy/Features/BurnsStudy/MI_features", patient_id + "CMI_5m_30shift.mat"))[filename]
    if int(chunk_len) == 180:
        data_mat = scipy.io.loadmat(os.path.join("/Users/TianyiZhang/Documents/EpilepsyVIP/DCEpy/Features/BurnsStudy/MI_features", patient_id + "CMI_3m_30shift.mat"))[filename]
